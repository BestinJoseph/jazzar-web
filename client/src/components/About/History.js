    ...
    return (
        <Box className={classes.history}>
            <Grid container>
                ...
                <Grid item lg={7} className={ classNames('rightContainer')}>
                    <Box className={ classNames( i18n.language === 'en' ? 'historyRightPanel' : 'historyRightPanel_arb') }>
                        <Box className={ classNames('ImagesSection')}>
                            <Slider {...settings}>
